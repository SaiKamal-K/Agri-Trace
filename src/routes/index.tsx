  ...
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <img src={heroImg} alt="" width={1920} height={1280} className="h-full w-full object-cover opacity-25 dark:opacity-15" />
      ...
      <div className="mx-auto max-w-7xl px-6 pb-24 pt-20 md:pt-32">
        ...
        >
          ...
          <h1 className="mt-6 font-display text-5xl font-semibold leading-[1.05] tracking-tight md:text-7xl">
            Automate farm <span className="italic text-primary">compliance</span><br />in minutes.
          </h1>
        ...
        >
          <div className="rounded-3xl border border-border/60 bg-card/80 p-2 shadow-elegant backdrop-blur">
